...
const styles = StyleSheet.create({
  ...
  grid:      { flexDirection: 'row', flexWrap: 'wrap', padding: Spacing.xl, paddingRight: Spacing.xl, gap: 12 },
  card:      { flex: 1, minWidth: '45%', maxWidth: '48%', borderRadius: Radius.lg, borderWidth: 0.5, padding: Spacing.lg, gap: 8 },
